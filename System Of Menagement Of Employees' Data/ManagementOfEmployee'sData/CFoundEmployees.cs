...
namespace ManagementOfEmployee_sData
{
    ...
    public partial class CFoundEmployees : TManyCoincidences
    {
        ...
        public CFoundEmployees(List<Employee> EmployeesData)
        {
            int width = 0;
        ...
        private void CFoundEmployeesClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
        ...
        MessageBoxOptions.DefaultDesktopOnly);
            ...
            {
                // Вызов формы "Введение новых данных" с передачей в нее данных выбранного сотрудника 
                this.Hide();
