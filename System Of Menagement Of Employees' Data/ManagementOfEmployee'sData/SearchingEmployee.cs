// Форма отвечающая за главную страницу Поиска сотрудника
...
namespace ManagementOfEmployee_sData
{
    ...
    public partial class SearchingEmployee : TSearchEmployee
    {
        // Вызов данной формы
        public SearchingEmployee()
        {
            InitializeComponent();
        }
        ...
        MessageBoxOptions.DefaultDesktopOnly);
            ...
            else
            {
                ...
                if (IDs.Count() == 0)
                {
                    ...
                    this.Hide();
                    var NotFound = new SNotFoundEmployee();
                    NotFound.Show();
                }
                ...
                else if (IDs.Count() == 1)
                {
                    ...
                    this.Hide();
                    var OneFound = new SFoundEmployee(Service.GetEmployee(IDs[0]));
                    OneFound.Show();
                }
                ...
                else
                {
                    ...
                    this.Hide();
                    var ManyFound = new SFoundEmployees(EmployeesData);
                    ManyFound.Show();
                }
            }
        }
        ...
        private void SearchingEmployeeClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
    }
